...
public class station_Avg_7Day {
    ...
    public station_Avg_7Day(int sId, float s1, float s2, float s3, float s4, float s5, float s6, float s7, float s8, float s9, LocalDateTime sTime) {
        this.sId = sId;
        this.s1 = s1;
        this.s2 = s2;
        this.s3 = s3;
