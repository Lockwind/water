...
public class buoy {
    ...
    public buoy(int bId, LocalDateTime bTime, float b001, float b003, float b010, float b011, float b015, float b060, float bA00, float bA01, float bA02, float bA03, float bA04, float bA05, float bA06, float bA07, float bA08, float bA09, float bA10, float bA11, float bA12, float bA13, float bA14, float bA15, float bA16) {
        this.bId = bId;
        this.bTime = bTime;
        this.b001 = b001;
        this.b003 = b003;
