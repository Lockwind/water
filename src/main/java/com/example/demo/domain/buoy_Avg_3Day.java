...
public class buoy_Avg_3Day {
    ...
    public buoy_Avg_3Day(LocalDateTime bTime, float bA0, float bA1, float bA2, float bA3, float bA4, float bA5, float bA6, float bA7, float bA8, float bA9, float bA10, float bA11, float bA12, float bA13, float bA14, float bA15, float bA16, float bA17, float bA18, float bA19, float bA20, float bA21, float bA22) {
        this.bTime = bTime;
        this.bA0 = bA0;
        this.bA1 = bA1;
        this.bA2 = bA2;
    ...
    public buoy_Avg_3Day(int bId, LocalDateTime bTime, float bA0, float bA1, float bA2, float bA3, float bA4, float bA5, float bA6, float bA7, float bA8, float bA9, float bA10, float bA11, float bA12, float bA13, float bA14, float bA15, float bA16, float bA17, float bA18, float bA19, float bA20, float bA21, float bA22) {
        this.bId = bId;
        this.bTime = bTime;
        this.bA0 = bA0;
        this.bA1 = bA1;
